...
const calculateOrderAmount = (order: Order): number => {
  ...
  return 2000; // changed this to $20 pin assuming USD
};
...
// app.get('/secret', async (req: express.Request, res: express.Response): Promise<void> => {
//   const intent = // ... Fetch or create the PaymentIntent
//   res.json({client_secret: intent.client_secret});
// });

app.listen(6000, (): void =>
  console.log(`Node server listening on port ${6000}!`)
);
